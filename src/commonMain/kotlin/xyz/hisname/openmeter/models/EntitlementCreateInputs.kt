...
sealed interface EntitlementCreateInputs {

    @SerialName(value = "usagePeriod") @Required val usagePeriod: RecurringPeriodCreateInput
    @SerialName(value = "type") @Required val type: EntitlementCreateInputs.Type
    ...
    @SerialName(value = "featureKey") val featureKey: kotlin.String?
    /* The feature the subject is entitled to use. Either featureKey or featureId is required.  */
    @SerialName(value = "featureId") val featureId: kotlin.String?
    ...
    @SerialName(value = "measureUsageFrom") val measureUsageFrom: MeasureUsageFromEnum?
