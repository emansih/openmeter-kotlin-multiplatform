package xyz.hisname.openmeter.infrastructure
...
import xyz.hisname.openmeter.auth.*
...
open class ApiClient(
    ...
    private val authentications: kotlin.collections.Map<String, Authentication> by lazy {
        mapOf(
                "PortalTokenAuth" to HttpBearerAuth("bearer"), 
                "CloudTokenAuth" to HttpBearerAuth("bearer"), 
                "CloudCookieAuth" to ApiKeyAuth("query", "__session"), 
                "CloudPortalTokenAuth" to HttpBearerAuth("bearer"))
    }

    companion object {
        const val BASE_URL = "http://127.0.0.1:8888"
